...
#           an AVAILABE/UNAVAILABLE marker. So, the
...
.equ AVAILABE,    1       # This is the number we will use to mark
...
#               memory availble, it will return 0 in %eax
#
####### PROCESSING #######
# Variables used:
#
...
alloc_loop_begin:                   # here we iterate through each
    ...
    cmpl  %ebx, %eax                # need more memory if these are
                                    # equal
    je    move_break

    # grap the size of this memory
...
deallocate:
    ...
    # don't need any of the fancy function staff
    ...
    movl  $AVAILABE, HDR_AVAIL_OFFSET(%eax)
